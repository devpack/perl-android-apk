...
public class PerlScriptProcess extends InterpreterProcess
{
  private final File mScript;

  public PerlScriptProcess(File paramFile, InterpreterConfiguration paramInterpreterConfiguration, AndroidProxy paramAndroidProxy) {
